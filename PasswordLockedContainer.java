...
public class PasswordLockedContainer extends Container {
	...
	/**
	 * Creates a password locked container with the given name, description,
	 * open state, locked state, and password to unlock the container.
	 * 
	 * @param name
	 *            the name of the container
	 * @param description
	...
	/**
	 * Called when the password is entered successfully. Prints a message
	 * reporting the success and then unlocks the container. This could be
	 * overridden by subclasses to customize the message and/or add additional
	 * effects.
	 */
	...
	/**
	 * Called when an incorrect password is entered. Prints a message reporting
	 * the failure. This could be overridden by subclasses to customize the
	 * message and/or add additional effects.
	 */
	...
	/**
	 * The message to print when prompting the user for the password. This could
	 * be overridden by subclasses to customize the prompt.
	 * 
	 * @return
	 */
	...
	public boolean execute(String command) {
		...
		if (command.equals("unlock " + getName())) {
			if (isLocked()) {
				...
				String pw = EscapeApp.IN.nextLine().trim().toLowerCase();
